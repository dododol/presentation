...
public class MemberCompanyController {
	...
	// 기업회원 리스트 조회
	@GetMapping
	public String memberList(Model model, @ModelAttribute("simpleCondition") SearchVO simpleCondition,
	...
	public String memberDetail(@PathVariable String companyId, Model model) {
	...
	public String usersInfoDelete(MemberVO member, RedirectAttributes redirectAttributes) {
