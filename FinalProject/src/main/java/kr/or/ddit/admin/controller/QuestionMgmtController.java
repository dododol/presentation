...
public class QuestionMgmtController {
	...
	// 1:1문의 리스트 조회
	@GetMapping
	public String questionList(Model model, @ModelAttribute("simpleCondition") SearchVO simpleCondition,
	...
	public String questionDetail(@PathVariable String qstnNo, Model model) {
